...
<head>
    ...
    <title>Login | Kang Digital</title>
    <!-- Google Fonts -->
    ...
    <style>
        ...
        * {
        ...
        /* Phone Mockup Style (Matches Welcome Page card design) */
        .mockup-container {
            flex: 1;
            display: flex;
            align-items: center;
...
<body>
    ...
    <div class="auth-wrapper">
        ...
        <div class="auth-panel-right">
            <h1>Login Member POS</h1>
            <p class="subtitle">Masuk dengan username atau email akun Kasir UMKM Anda.</p>
            ...
            <form action="{{ route('login.post') }}" method="POST">
                ...
                <div class="form-group">
                    <label for="login_input">Username atau Email</label>
                    <div class="input-wrapper">
                        <i class="fa-solid fa-user-tag"></i>
                        <input type="text" name="login_input" id="login_input" placeholder="username atau email@domain.com" value="{{ old('login_input') }}" required autofocus>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="password" name="password" id="password" placeholder="••••••••" required style="padding-right: 48px;">
                        <i class="fa-solid fa-eye" id="toggle-password" style="position: absolute; right: 16px; left: auto; cursor: pointer; color: #94a3b8; transition: color 0.2s;" onclick="togglePasswordVisibility()"></i>
                    </div>
                </div>
